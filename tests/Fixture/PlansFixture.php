...
class PlansFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'server_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_indexes' => [
        ...
        '_constraints' => [
            ...
            'plans_ibfk_2' => ['type' => 'foreign', 'columns' => ['server_id'], 'references' => ['servers', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
